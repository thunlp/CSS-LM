...
BASELINE_file=baseline_n_result_open_domain_sst5_entropy_finetune_all
mkdir $BASELINE_file
rm -rf $BASELINE_file/*
...
do
    ...
    ###########
    OUTFILE="output_pretrain_roberta_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_sst5_entropy_finetune_all"
    '''
    rm -rf $OUTFILE
    mkdir $OUTFILE
    '''
...
BASELINE_file=baseline_bert_n_result_open_domain_sst5_entropy_finetune_all
mkdir $BASELINE_file
rm -rf $BASELINE_file/*
...
do
    ...
    ###Train Baseline models
    ###########
    OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_sst5_entropy_finetune_all"
    '''
    rm -rf $OUTFILE
    mkdir $OUTFILE
    '''
