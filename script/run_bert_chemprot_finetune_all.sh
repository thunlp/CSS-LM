...
#fix
###
#FINAL_file=final_n_result_open_domain_chemprot_entropy_finetune
#RETRIVER_file=retriver_n_result_open_domain_chemprot_entropy_finetune
#BASELINE_file=baseline_n_result_open_domain_chemprot_entropy_finetune
FINAL_file=final_bert_n_result_open_domain_chemprot_entropy_finetune
RETRIVER_file=retriver_bert_n_result_open_domain_chemprot_entropy_finetune
BASELINE_file=baseline_bert_n_result_open_domain_chemprot_entropy_finetune
###
mkdir $FINAL_file
mkdir $RETRIVER_file
mkdir $BASELINE_file
...
do
    ...
    #fix
    ###
    #OUTFILE="output_pretrain_roberta_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_chemprot_entropy_finetune"
    OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_chemprot_entropy_finetune_all"
    ###
    rm -rf $OUTFILE
    mkdir $OUTFILE
