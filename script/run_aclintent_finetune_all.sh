...
FINAL_file=final_n_result_open_domain_aclintent_entropy_finetune_all
RETRIVER_file=retriver_n_result_open_domain_aclintent_entropy_finetune_all
BASELINE_file=baseline_n_result_open_domain_aclintent_entropy_finetune_all
mkdir $FINAL_file
mkdir $RETRIVER_file
mkdir $BASELINE_file
rm -rf $FINAL_file/*
...
do
    ...
    ###########
    OUTFILE="output_pretrain_roberta_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_aclintent_entropy_finetune_all"
    rm -rf $OUTFILE
    mkdir $OUTFILE
