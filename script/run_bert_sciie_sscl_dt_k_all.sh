...
#fix
###
#FINAL_file=final_n_result_open_domain_sciie_entropy_sscl_dt
#RETRIVER_file=retriver_n_result_open_domain_sciie_entropy_sscl_dt
#BASELINE_file=baseline_n_result_open_domain_sciie_entropy_sscl_dt
FINAL_file=final_bert_n_result_open_domain_sciie_entropy_sscl_dt
RETRIVER_file=retriver_bert_n_result_open_domain_sciie_entropy_sscl_dt
BASELINE_file=baseline_bert_n_result_open_domain_sciie_entropy_sscl_dt
###
mkdir $FINAL_file
mkdir $RETRIVER_file
mkdir $BASELINE_file
...
do
    ...
    #fix
    ###
    OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_sciie_entropy_sscl_dt_all"
    ###
    rm -rf $OUTFILE
    mkdir $OUTFILE
    ...
    DATA_out=data/opendomain_finetune_sciie_10000_all/
    ...
    OUTPUT=data/opendomain_finetune_sciie_10000_all
    #fix
    ###
    #MODEL=roberta-base-768-sciie-DomainTask-noword-sentiment-HEADandTAIL-opendomain-entropy-self
    MODEL=bert-base-768-sciie-DomainTask-noword-sentiment-HEADandTAIL-opendomain-entropy-self_all
    ###
    mkdir $OUTPUT
    mkdir $MODEL
    rm -rf $MODEL/*
    ...
    ######################################################
    #####
    #rm output_pretrain_roberta_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_sciie_entropy_st/*
    #cp -r $OUTFILE/* output_pretrain_roberta_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_sciie_entropy_st/
    #####
    mkdir backup_sciie_all
    rm backup_sciie_all/*
    cp -r $OUTFILE/* backup_sciie_all/
    ...
    do
        #fix
        ###
        #OUTFILE="output_pretrain_roberta_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_sciie_entropy_sscl_dt"
        OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_sciie_entropy_sscl_dt_all"
        ###
        ###
        rm -rf $OUTFILE
        mkdir $OUTFILE
        cp -r backup_sciie/* $OUTFILE/
        ###
        INPUT=data/openwebtext/train.txt
        OUTPUT=data/opendomain_finetune_sciie_10000_all
        #fix
        ...
        #fix
        ###
        #RETRIVER_file=retriver_n_result_open_domain_sciie_entropy_sscl_dt_$K"_"$ITER
        RETRIVER_file=retriver_bert_n_result_open_domain_sciie_entropy_sscl_dt_all_$K"_"$ITER
        ###
        mkdir $RETRIVER_file
        rm -rf $RETRIVER_file/*
        ###
