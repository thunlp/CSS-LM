...
FINAL_file=final_bert_n_result_open_domain_aclintent_entropy_st
RETRIVER_file=retriver_bert_n_result_open_domain_aclintent_entropy_st
BASELINE_file=baseline_bert_n_result_open_domain_aclintent_entropy_st
###
mkdir $FINAL_file
mkdir $RETRIVER_file
mkdir $BASELINE_file
...
do
    ...
    OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_aclintent_entropy_st"
    ###
    '''
    rm -rf $OUTFILE
    mkdir $OUTFILE
    ...
    do
        ...
        ###
        #OUTFILE="output_pretrain_roberta_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_aclintent_entropy_st"
        OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_aclintent_entropy_st_all"
        ###
        rm -rf $OUTFILE
        mkdir $OUTFILE
        ###
        cp -r backup_aclintent_all/* $OUTFILE/
        ###
        INPUT=data/openwebtext/train.txt
        ...
        RETRIVER_file=retriver_bert_n_result_open_domain_aclintent_entropy_st_$K"_"$ITER
        ###
        mkdir $RETRIVER_file
        rm -rf $RETRIVER_file/*
