...
FINAL_file=final_n_result_open_domain_sst5_entropy_scl_dt
RETRIVER_file=retriver_n_result_open_domain_sst5_entropy_scl_dt
BASELINE_file=baseline_n_result_open_domain_sst5_entropy_scl_dt
mkdir $FINAL_file
mkdir $RETRIVER_file
mkdir $BASELINE_file
rm -rf $FINAL_file/*
...
do
    ...
    ###########
    OUTFILE="output_pretrain_roberta_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_sst5_entropy_scl_dt"
    rm -rf $OUTFILE
    mkdir $OUTFILE
