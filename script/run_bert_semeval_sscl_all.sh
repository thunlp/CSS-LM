...
#fix
###
#FINAL_file=final_n_result_open_domain_entropy_sscl
#RETRIVER_file=retriver_n_result_open_domain_entropy_sscl
#BASELINE_file=baseline_n_result_open_domain_entropy_sscl
...
do
    ...
    OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_entropy_sscl_all"
    ###
    rm -rf $OUTFILE
    mkdir $OUTFILE
    ...
    rm -rf DATA_out
    cp -r data/opendomain_finetune_noword_10000 data/opendomain_finetune_noword_10000_all
