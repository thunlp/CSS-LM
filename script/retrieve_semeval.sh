...
BASELINE_file=retrieve_semeval
#mkdir $FINAL_file
#mkdir $RETRIVER_file
mkdir $BASELINE_file
#rm -rf $FINAL_file/*
...
do
    ...
    #INPUT=data/openwebtext/retrieve.txt
    ...
    CUDA_VISIBLE_DEVICES=$EVAL_GPU python3 code/gen_word_more_than_50.py $INPUT $OUTPUT/train $MODEL $INSTANCE_1 $NUM_LABEL $RETRIVE_BATCH
    '''
    ...
    CUDA_VISIBLE_DEVICES=$TRAIN_GPU python3.6 -W ignore::UserWarning code/retrieve.py   --num_labels_task $NUM_LABEL --do_train   --do_lower_case   --data_dir_outdomain $DATA_out  --data_dir_indomain $DATA_in --pretrain_model $MODEL --max_seq_length 100 --train_batch_size $BATCH_SIZE --learning_rate $LEARNING_RATE   --num_train_epochs $N_times_1   --output_dir $OUTFILE  --loss_scale 128 --weight_decay 0 --adam_epsilon 1e-8 --max_grad_norm 1 --fp16_opt_level O1 --task 0 --fp16 --augment_times 20 --K 16
