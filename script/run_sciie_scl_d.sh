...
FINAL_file=final_n_result_open_domain_sciie_entropy_scl_d
RETRIVER_file=retriver_n_result_open_domain_sciie_entropy_scl_d
BASELINE_file=baseline_n_result_open_domain_sciie_entropy_scl_d
mkdir $FINAL_file
mkdir $RETRIVER_file
mkdir $BASELINE_file
rm -rf $FINAL_file/*
...
do
    ...
    ###########
    OUTFILE="output_pretrain_roberta_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_sciie_entropy_scl_d"
    rm -rf $OUTFILE
    mkdir $OUTFILE
