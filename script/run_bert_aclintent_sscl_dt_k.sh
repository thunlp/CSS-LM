...
do
    ...
    #fix
    ###
    OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_aclintent_entropy_sscl_dt"
    ###
    rm -rf $OUTFILE
    mkdir $OUTFILE
    ...
    MODEL=bert-base-768-aclintent-DomainTask-noword-sentiment-HEADandTAIL-opendomain-entropy-self
    ###
    mkdir $OUTPUT
    mkdir $MODEL
    rm -rf $MODEL/*
    ...
    #####
    mkdir backup_aclintent
    rm backup_aclintent/*
    cp -r $OUTFILE/* backup_aclintent/
