...
FINAL_file=final_bert_n_result_open_domain_sst5_entropy_finetune
RETRIVER_file=retriver_bert_n_result_open_domain_sst5_entropy_finetune
BASELINE_file=baseline_bert_n_result_open_domain_sst5_entropy_finetune
###
mkdir $FINAL_file
mkdir $RETRIVER_file
mkdir $BASELINE_file
...
do
    ...
    ###########
    OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_sst5_entropy_finetune"
    rm -rf $OUTFILE
    mkdir $OUTFILE
