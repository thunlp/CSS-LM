...
FINAL_file=final_n_result_open_domain_scicite_entropy_sscl_t
RETRIVER_file=retriver_n_result_open_domain_scicite_entropy_sscl_t
BASELINE_file=baseline_n_result_open_domain_scicite_entropy_sscl_t
mkdir $FINAL_file
mkdir $RETRIVER_file
mkdir $BASELINE_file
rm -rf $FINAL_file/*
...
do
    ...
    ###########
    OUTFILE="output_pretrain_roberta_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_scicite_entropy_sscl_t"
    rm -rf $OUTFILE
    mkdir $OUTFILE
