        ...
        for epo in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch_ in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                if n_gpu > 1:
                    ...
                    #loss = task_loss_org.mean() + in_domain_task_binary_loss.mean()  + in_task_binary_loss.mean()
                    loss = task_loss_org.mean() + in_domain_task_binary_loss.mean()  + in_domain_binary_loss.mean()
