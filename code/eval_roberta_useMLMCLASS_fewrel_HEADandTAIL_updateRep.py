...
def main():
    ...
    ####
    ####
    train_example, label_list = processor.get_train_examples(args.data_dir)
    ...
    test = convert_examples_to_features(
        test_examples, label_list, args.max_seq_length, tokenizer, args.task)

    dev = convert_examples_to_features(
        eval_examples, label_list, args.max_seq_length, tokenizer, args.task)
    ###
