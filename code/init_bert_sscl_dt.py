...
def convert_example_to_features(example, max_seq_length, tokenizer):
    ...
    #print("----")
    #print(tokens_a)
    #print(tokenizer.encode(tokens_a))
    #print(tokenizer.decode(tokenizer.encode(tokens_a)))
    #exit()
    #print(tokens_a_org)
    #exit()
    #print(t1_label)
    ...
    if args.do_train:
        ...
        for epo in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            for step, batch_ in enumerate(tqdm(train_dataloader, desc="Iteration")):
                ...
                in_task_binary_loss, task_binary_logit = model(all_in_task_rep_comb=all_in_task_rep_comb, all_sentence_binary_label=all_sentence_binary_label, func="task_binary_classifier", use_detach=use_detach)
