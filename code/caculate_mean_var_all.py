    ...
    for mode in modes:
        ...
        for i in times_list: #1~5
            ...
            try:
                ...
                #find file
                test_file = [f for f in fileDir if "test_paper_results" in f and "txt_no_eval" not in f][0]
                eval_file = [f for f in fileDir if "eval_results" in f][0]
                #test
