...
do
    ...
    do
        ...
        ###
        #OUTFILE="output_pretrain_roberta_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_chemprot_entropy_st"
        OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_chemprot_entropy_st_all"
        ###
        rm -rf $OUTFILE
        mkdir $OUTFILE
        ###
        cp -r backup_chemprot_all/* $OUTFILE/
        ###
        INPUT=data/openwebtext/train.txt
