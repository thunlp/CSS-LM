...
FINAL_file=final_test
RETRIVER_file=retriver_test
BASELINE_file=baseline_test
mkdir $FINAL_file
mkdir $RETRIVER_file
mkdir $BASELINE_file
rm -rf $FINAL_file/*
...
do
    ...
    ###########
    OUTFILE="output_pretrain_roberta_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_entropy_sscl_dt_meta"
    rm -rf $OUTFILE
    mkdir $OUTFILE
