...
do
    ...
    #fix
    ###
    OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_chemprot_entropy_sscl_dt"
    ###
    rm -rf $OUTFILE
    mkdir $OUTFILE
    ...
    #####
    mkdir backup_chemprot
    rm backup_chemprot/*
    cp -r $OUTFILE/* backup_chemprot/
    ...
    do
        ...
        RETRIVER_file=retriver_bert_n_result_open_domain_chemprot_entropy_sscl_dt_$K"_"$ITER
        ###
        mkdir $RETRIVER_file
        rm -rf $RETRIVER_file/*
        ###
