...
do
    ...
    #fix
    ###
    OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_sst5_entropy_sscl_dt"
    ###
    rm -rf $OUTFILE
    mkdir $OUTFILE
    ...
    OUTPUT=data/opendomain_finetune_sst5_10000
    #fix
    ###
    #MODEL=roberta-base-768-sst5-DomainTask-noword-sentiment-HEADandTAIL-opendomain-entropy-self
    MODEL=bert-base-768-sst5-DomainTask-noword-sentiment-HEADandTAIL-opendomain-entropy-self
    ###
    mkdir $OUTPUT
    mkdir $MODEL
    rm -rf $MODEL/*
    ...
    do
        ...
        RETRIVER_file=retriver_bert_n_result_open_domain_sst5_entropy_sscl_dt_$K"_"$ITER
        ###
        mkdir $RETRIVER_file
        rm -rf $RETRIVER_file/*
        ###
