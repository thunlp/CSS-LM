...
do
    ...
    #fix
    ###
    OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_scicite_entropy_sscl_dt_all"
    ###
    rm -rf $OUTFILE
    mkdir $OUTFILE
    ...
    #####
    mkdir backup_scicite_all
    rm backup_scicite_all/*
    cp -r $OUTFILE/* backup_scicite_all/
    ...
    do
        ...
        RETRIVER_file=retriver_bert_n_result_open_domain_scicite_entropy_sscl_dt_all_$K"_"$ITER
        ###
        mkdir $RETRIVER_file
        rm -rf $RETRIVER_file/*
        ###
