...
FINAL_file=final_n_result_open_domain_entropy_finetune_all
RETRIVER_file=retriver_n_result_open_domain_entropy_finetune_all
BASELINE_file=baseline_n_result_open_domain_entropy_finetune_all
mkdir $FINAL_file
mkdir $RETRIVER_file
mkdir $BASELINE_file
rm -rf $FINAL_file/*
