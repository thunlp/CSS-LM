...
#fix
###
#FINAL_file=final_n_result_open_domain_aclintent_entropy_sscl
#RETRIVER_file=retriver_n_result_open_domain_aclintent_entropy_sscl
#BASELINE_file=baseline_n_result_open_domain_aclintent_entropy_sscl

FINAL_file=final_bert_n_result_open_domain_aclintent_entropy_sscl
RETRIVER_file=retriver_bert_n_result_open_domain_aclintent_entropy_sscl
BASELINE_file=baseline_bert_n_result_open_domain_aclintent_entropy_sscl
###
mkdir $FINAL_file
mkdir $RETRIVER_file
mkdir $BASELINE_file
...
do
    ...
    #fix
    ###
    #OUTFILE="output_pretrain_roberta_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_aclintent_entropy_sscl"
    OUTFILE="output_pretrain_bert_including_Preprocess_DomainTask_sentiment_noaspect_HEADandTAIL_opendomain_aclintent_entropy_sscl_all"
    ###
    rm -rf $OUTFILE
    mkdir $OUTFILE
    ...
    rm -rf DATA_out
    cp -r data/opendomain_finetune_aclintent_10000 data/opendomain_finetune_aclintent_10000_all
